...
static const struct pygpgme_constant constants[] = {
  ...
  CONST(STATUS_SIG_SUBPACKET),
  CONST(STATUS_NEED_PASSPHRASE_PIN),
  CONST(STATUS_SC_OP_FAILURE),
  CONST(STATUS_SC_OP_SUCCESS),
  CONST(STATUS_CARDCTRL),
  CONST(STATUS_BACKUP_KEY_CREATED),
  CONST(STATUS_PKA_TRUST_BAD),
  CONST(STATUS_PKA_TRUST_GOOD),
  CONST(STATUS_PLAINTEXT),
  CONST(STATUS_INV_SGNR),
  CONST(STATUS_NO_SGNR),
  CONST(STATUS_SUCCESS),
  CONST(STATUS_DECRYPTION_INFO),
  CONST(STATUS_PLAINTEXT_LENGTH),
  CONST(STATUS_MOUNTPOINT),
  CONST(STATUS_PINENTRY_LAUNCHED),
  CONST(STATUS_ATTRIBUTE),
  CONST(STATUS_BEGIN_SIGNING),
  CONST(STATUS_KEY_NOT_CREATED),
  CONST(STATUS_INQUIRE_MAXLEN),
  CONST(STATUS_FAILURE),
  CONST(STATUS_KEY_CONSIDERED),
  CONST(STATUS_TOFU_USER),
  CONST(STATUS_TOFU_STATS),
  CONST(STATUS_TOFU_STATS_LONG),
  CONST(STATUS_NOTATION_FLAGS),
  CONST(STATUS_DECRYPTION_COMPLIANCE_MODE),
  CONST(STATUS_VERIFICATION_COMPLIANCE_MODE),
  CONST(STATUS_CANCELED_BY_USER),
